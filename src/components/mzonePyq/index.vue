    ...
    <div class="pyq-com-wrapper">
      <div class="item" v-for="(item, pyqIndex) in pyqList" :key="item._id">
        ...
        <div class="body">
          ...
          <div class="pictures"> 
            <span class="picture-item" v-for="imgItem in item.pictures" :key="imgItem.guid" @click="setCurrentImgUrl(imgItem.url)">
        ...
        <div class="comment-area">
          <el-input placeholder="知道的不全说，听到的不全信~" v-model="commentsObj[item._id]" :ref="'commentInp'+item._id" />
          <i
...
import ZoneSvg from "@/SVGComponents/mzone";
...
export default {
  ...
  methods: {
    ...
    setCurrentImgUrl(url) {
      // 设置当前图片的url
      this.currentImgUrl = url; // 图片地址
      this.showPicturePreview = true; // 显示图片预览
    },
    // 关闭图片预览
